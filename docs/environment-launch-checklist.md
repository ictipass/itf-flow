...
- [ ] Set `NEXT_PUBLIC_WORKSPACE_LOGOUT_URL` to the same-origin Workspace catalogue
  (`https://itf-workspace-staging.vercel.app/dashboard/apps` for the approved staging environment).
