...
| Guided correspondence origination | Document type, compatible workflow category, routing purpose and sequential recipient responsibilities are explained at the point of entry. | All staff | Incoming registration remains role-scoped; action routing depends on synchronized Workspace hierarchy. |
